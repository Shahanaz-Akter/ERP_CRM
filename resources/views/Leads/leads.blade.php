            ...
            <div class="p-3" style="">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="header p-3 d-flex slign-items-center justify-content-end ">
                        <div class="start">
                            <div class="btn-group">
                                <button type="button" class="btn btn-primary"><a href="/create_leads"
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item"
                                            href="{{url('/leads/autoresponders')}}">Autoresponders</a></li>
                                    ...
                                    <li><a class="dropdown-item" href="javascript:void(0);" data-bs-toggle="modal"
                                            data-bs-target="#modalTop">Add to Campaigns</a></li>
