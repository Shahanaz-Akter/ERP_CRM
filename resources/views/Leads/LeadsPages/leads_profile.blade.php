    ...
    <div class="">
        ...
        <div style="background-color:#fff; width:100%"
            ...
            <div class="pe-5">
                ...
                <button type="button" class="btn btn-secondary" onclick="window.location.href='{{ url('/leads/editProfile') }}'">Edit</button>
                        ...
                        <div class="row mx-4">
                            <div class="col-xl-6 col-lg-8 col-md-9 d-flex">
                                <div class="me-5 text-end">
                                    ...
                                    <span class="d-block">Phone</span>
                                    <span class="d-block line-space">Mobile</span>
                                    <span class="d-block">Lead Source</span>
            ...
            <form class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="table-wrapper ">
                        @include('Leads.LeadsPages.add_product_list')
                    </div>
