              ...
              <div class="row my-3">
                ...
                <div class="col-sm-9">
                  <select id="custom-view" class="select2 form-select" data-allow-clear="true">
                    ...
                    <option value="recentlyCreatedLeads">Recently Created Leads</option>
                    <option value="recentlyModifiedLeads">Recently Modified Leads</option>
                    <option value="today'sLeads">Today's Leads</option>
                    <option value="unreadLeads">Unread Leads</option>
                    <option value="unsubscribedLeads">Unsubscribed Leads</option>
                  </select>
                </div>
              </div>
              <div class="row my-3">
