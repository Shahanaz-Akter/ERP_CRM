...
<body class="" style="color:black; background-color:#fff">
   ...
   <div>
        ...
        <div class="pt-5">
            ...
            <div class="my-5 ms-5">
                <a href="{{url('/leads/autoresponders/new-autoresponder')}}"><button type="button" class="btn btn-primary">Create Autoresponders</button></a>
                <a href="{{url('/leads/autoresponders/create-folder')}}"><button type="button" class="btn btn-secondary">Create Folder</button></a>
            </div>
           <div>
