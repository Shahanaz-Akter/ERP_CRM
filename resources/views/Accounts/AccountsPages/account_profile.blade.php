    ...
    <div class="">
        ...
        <div style="background-color:#fff; width:100%"
            ...
            <div class="d-flex align-items-center">
                <a href="{{ url('/accounts') }}" class="fs-4 ms-4"><i class="fa-sharp fa-solid fa-arrow-left"></i> </a>
            ...
            <div class="pe-5">
                ...
                <button type="button" class="btn btn-secondary" onclick="window.location.href='{{ url('/accounts/editProfile    ') }}'">Edit</button>
                        ...
                        <div class="row mx-4">
                            <div class="col-xl-6 col-lg-8 col-md-9 d-flex">
                                <div class="me-5 text-end">
                                    ...
                                    <span class="d-block">Phone</span>
                                    <span class="d-block line-space">Mobile</span>
                                    <span class="d-block">Accounts Source</span>
                            ...
                            <div class="col-xl-6 col-lg-8 col-md-9 d-flex">
                                <div class="me-5 text-end">
                                    ...
                                    <span class="d-block line-space">Accounts Name</span>
            ...
            <form class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="table-wrapper ">
                        @include('Contacts.ContactPages.contact_add_product')
                    </div>
