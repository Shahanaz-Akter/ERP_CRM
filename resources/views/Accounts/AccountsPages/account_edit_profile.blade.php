...
<body>
    ...
    <div  style="background-color:#fff; height:100vh; width:100%;overflow:scroll;">
        <div style="width:100%"
            ...
            <h4 style="color:black" class=" mx-4 pt-2">Edit Accounts</h4>
            <div class="pe-5">
        ...
        <div style="padding-left: 40px" class="pt-4">
            <span style="color: #000;" class="fw-bold">Accounts Image</span><br>  <br>
        ...
        <div class="info-container pt-5">
            <h5 style="color:black">Accounts Information</h5>
            <div class="row mx-4">
                <div class=" col-xl-6 col-lg-6 col-md-6">    
                    <div class="mb-3 row">
                        <label style=" " for="html5-text-input" class="col-md-3 col-form-label text-end leftText">Accounts Owner</label>
                        <div class="col-md-9">
                ...
                <div class=" col-xl-6 col-lg-6 col-md-6">
                    ...
                    <div class="mb-3 row">
                        <label style=" " for="html5-text-input" class="col-md-3 col-form-label text-end leftText">Accounts Name</label>
                        <div class="col-md-9">
                    ...
                    <div class="mb-3 row">
                        <label style=" " for="html5-text-input" class="col-md-3 col-form-label text-end leftText">Accounts Status</label>
                        <div class="col-md-9">
