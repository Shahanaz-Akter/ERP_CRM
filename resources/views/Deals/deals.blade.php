...
<body>
    ...
    <!-- Layout wrapper -->
    <div class=" d-flex">
        @include('Deals.deals_filter_sidebar')
            ...
            <div class="p-3" style="">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="header p-3 d-flex slign-items-center justify-content-end ">
                        <div class="start">
                            <div class="btn-group">
                                <button type="button" class="btn btn-primary"><a href="/create_deals"
                                        class="text-white">Create Deals</a></button>
                        ...
                        <div class="middle ms-3">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="{{url('/deals/deals-mass-delete')}}">Mass Delete</a>
                                    </li>
                                    <li><a class="dropdown-item" href="{{url('/deals/deals-mass-update')}}">Mass Update</a>
                                    </li>
                                    {{-- <li><a class="dropdown-item" href="{{url('/leads/mass-convert')}}">Mass Convert</a>
                                    </li> --}}
                                    <li><a class="dropdown-item" href="{{url('/deals/deals-manage-tags')}}">Manage Tags</a>
                                    </li>
                                    <li><a class="dropdown-item" href="{{url('/deals/deals-drafts')}}">Drafts</a></li>
                                    <li><a class="dropdown-item" href="{{url('/deals/mass-email')}}">Mass Email</a></li>
                ...
                @include('Deals.DealsPages.deals_list')
