...
<body>
  ...
  $AnnualRevenue = ["=", "!=", "<", "<=" , ">" , ">=" , "between" , "not between" , "is empty" , "is not emply" ];
    ...
    $Created_By=["is", "isn't" , "is empty" , "is not empty" ]; $createdTime=["is", "isn't" , "is  before" , "is after"
    , "between" , "not between" , "today" , "Tomorrow" , "Starting tomorrow" , "Yesterday" , " Till  Yesterday"
    , "Last Month" , "Current Month" , "Next Month" , "Last Week" , "Current Week" , "Next Week" , "This Year"
    , "Current FY" , "Current FQ" , "Last Year" , "Previous FY" , "Previous FQ" , "Next Year" , "Next FY" , "Next FQ"
    , "Age in Days" , "Due in Days" , "is empty" , "is not empty" ]; $EmailOptOut=["is"]; @endphp
    @include('components.navbar') <!-- Layout wrapper -->
    <div>
      <!-- Leads - Mass Delete -->
      <div class="col-12">
        <div class="card">
          <div class="d-flex align-content-center flex-wrap mx-3 mt-3">
            <a href="{{ url('/deals') }}" class="fs-4 "><i class="fa-sharp fa-solid fa-arrow-left"></i> </a>
            <h5 class=" mx-2 mt-1 pt-1">Drafts</h5>
          </div>
          {{-- <h5 class="card-header">Drafts</h5> --}}
          <div class="card-body">
            <h6>Criteria</h6>
            <form class="form-repeater mt-2">
              <div class="row">
                  ...
                  <div data-repeater-item>
                    <div style="height: 50px;" class="row">
                      <div class="mb-3 col-lg-6 col-xl-2 col-12 mb-0">
                        ...
                        {{-- onblur="selectDropdown()" --}}
                        <select id="form-repeater-1-3" onclick="selectDropdown()" class="form-select">
                      ...
                      <div class="mb-3 col-lg-6 col-xl-2 col-12 mb-0">
                        ...
                        {{-- <select id="form-repeater-1-4" onclick="secontDropdown()" class="form-select"> --}}
      ...
      <script>
        const selectDropdown  = () =>{
          ...
          // Annual Revenue Lead Conversion Time, No. of Employees
          else if ($firstOption1 === "Annual Revenue" || $firstOption1 === "Lead conversion Time" || $firstOption1 === "No. of Employees" || $firstOption1 === "Days Visited") {
              document.getElementById("date-input").classList.add('d-none');
              document.getElementById("time-input").classList.add('d-none');
              document.getElementById("text-inpit").classList.remove("d-none");  
           ...
           else if ($firstOption1 === "City" || $firstOption1 === "Company" || $firstOption1 === "Country" || $firstOption1 === "Email" || $firstOption1 === "fax"
          || $firstOption1 === "First Name" || $firstOption1 === "Industry" || $firstOption1 === "Last Name" || $firstOption1 === "Lead Source" || $firstOption1 === "Mobile"
          || $firstOption1 === "Lead Status" || $firstOption1 === "Phone" || $firstOption1 === "Rating" || $firstOption1 === "Salutation" || $firstOption1 === "Skype ID" 
          || $firstOption1 === "Secondary Email" || $firstOption1 === "State" || $firstOption1 === "Street" || $firstOption1 === "Title" || $firstOption1 === "Twitter" 
          || $firstOption1 === "Unsubscribed Mode" || $firstOption1 === "Unsubscribed Time" || $firstOption1 === "Website" || $firstOption1 === "Zip Code" || $firstOption1 === "First Page Visited") {
              document.getElementById("date-input").classList.add('d-none');
              document.getElementById("time-input").classList.add('d-none');
              document.getElementById("text-inpit").classList.remove("d-none");
              document.getElementById("form-repeater-1-4").classList.add("d-none");
           ...
           else if ($firstOption1 === "Created By" || $firstOption1 === "Lead Owner" || $firstOption1 === "Modified By") {
              document.getElementById("date-input").classList.add('d-none');
              document.getElementById("time-input").classList.add('d-none');
              document.getElementById("text-inpit").classList.remove("d-none");
              document.getElementById("form-repeater-1-4").classList.add("d-none");
           ...
           else if ($firstOption1 === "Created Time" || $firstOption1 === "First Visit" || $firstOption1  === "Last Activity Time" || $firstOption1 === "Modified Time") {
              document.getElementById("form-repeater-1-4").classList.add("d-none");
              document.getElementById("form-repeater-1-5").classList.add("d-none");
              document.getElementById("form-repeater-1-6").classList.add("d-none");
              document.getElementById("form-repeater-1-7").classList.add("d-none");
      ...
      <!-- for data tables -->
      <div class="bg-white mt-4 py-4 text-center">
          <span class="text-center text-muted">No records available</span>
      </div>
