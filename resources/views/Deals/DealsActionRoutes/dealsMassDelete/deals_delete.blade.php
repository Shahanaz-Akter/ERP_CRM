...
<body>
    ...
    $AnnualRevenue = ['=', '!=', '<', '<=' , '>' , '>=' , 'between' , 'not between' , 'is empty' , 'is not emply' ];
        $city=['is', "isn't" , 'contains' , "doesn't contains" , 'starts  with' , 'ends with' , 'is empty'
        , 'is not empty' ]; $Created_By=['is', "isn't" , 'is empty' , 'is not empty' ]; $createdTime=['is', "isn't"
        , 'is  before' , 'is after' , 'between' , 'not between' , 'today' , 'Tomorrow' , 'Starting tomorrow'
        , 'Yesterday' , ' Till  Yesterday' , 'Last Month' , 'Current Month' , 'Next Month' , 'Last Week'
        , 'Current Week' , 'Next Week' , 'This Year' , 'Current FY' , 'Current FQ' , 'Last Year' , 'Previous FY'
        , 'Previous FQ' , 'Next Year' , 'Next FY' , 'Next FQ' , 'Age in Days' , 'Due in Days' , 'is empty'
        , 'is not empty' ]; $EmailOptOut=['is']; @endphp @include('components.navbar') <!-- Layout wrapper -->
        <div>
            <!-- Leads - Mass Delete -->
            <div class="col-12">
                ...
                <div class="card">
                    <div class="d-flex align-content-center flex-wrap mx-3 mt-3">
                        ...
                        <h5 class=" mx-4 pt-1">Deals - Mass Delete</h5>
                    </div>
                    <div class="card-body">
                        <h6>Criteria</h6>
                        <div >
                            <form style="width:100%" class="form-repeater mt-1 me-4">
                                <div class="row">
            ...
            <div class="bg-white  mt-4">
                ...
                {{-- @include('Leads.actionRoutes.mass_delete_list'); --}}
                @include('Deals.DealsActionRoutes.dealsMassDelete.deals_delete_list');
            </div>
            ...
            {{-- //for date picker --}}
            <script src="{{ asset('/assets/vendor/libs/bootstrap-daterangepicker/bootstrap-daterangepicker.js') }}">
            </script>
            {{-- //for date picker --}}
            ...
            <script type="text/javascript" src="https://cdn.datatables.net/select/1.6.0/js/dataTables.select.min.js">
            </script>
            --}}
</body>
