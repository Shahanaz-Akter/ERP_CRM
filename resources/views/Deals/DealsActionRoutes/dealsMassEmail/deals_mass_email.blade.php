        ...
        <div class="px-3 mx-4 mt-4 rounded-3" id="mass-email-box">
            ...
            <div class="d-flex justify-content-between">
                <div style="color:black" class="d-flex border border-2 rounded-pill p-1">
                    ...
                    <a style="color:black; height:25px" class="p-2 mx-3 fw-bolder py-0 Sent" href="{{url('/deals/send-mass-email')}}" id="sentId">Sent</a>
                    <a style="color:black; height:25px" class="p-2 fw-bolder py-0 Stopped" href="{{url('/deals/stopped-mass-email')}}" id="stoppedId">Stopped</a>
                </div>
                <div>
                    <button type="button" id="table-top-btn" class="btn btn-primary"><a class="text-white" href="{{url('/deals/new-mass-email')}}">Create Mass Email</a></button>
                </div>
            </div>
