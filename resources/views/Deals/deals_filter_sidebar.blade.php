<div style="width:380px;" class="filter_sidebar">
    <label class="p-2">Filter Deals By</label>
        ...
        <ul>
            ...
            <li>
                ...
                <ul class=" outer_ul">
                    ...
                    <li>
                        <input type="checkbox" class="check_btn" id="city">
                        <label class="ms-2 " for="city">Amount</label>
                    ...
                    <li>
                        <input type="checkbox" class="check_btn" id="city">
                        <label class="ms-2 " for="city">Campaign Source</label>
                    ...
                    <li>
                        ...
                        <label class="ms-2 " for="created_time">Closing Date</label>
                        <div class="content d-none ms-3">
                    ...
                    <li>
                        <input type="checkbox" class="check_btn" id="city">
                        <label class="ms-2 " for="city">Deal Name</label>
                    ...
                    <li>
                        <input type="checkbox" class="check_btn" id="city">
                        <label class="ms-2 " for="city">Deal Owner</label>
                    ...
                    <li>
                        <input type="checkbox" class="check_btn" id="city">
                        <label class="ms-2 " for="city">Expected Revenue</label>
                    ...
                    <li>
                        <input type="checkbox" class="check_btn" id="city">
                        <label class="ms-2 " for="city">Lead Conversion Time</label>
                    ...
                    <li>
                        <input type="checkbox" class="check_btn" id="city">
                        <label class="ms-2 " for="city">Lead Source</label>
                    ...
                    <li>
                        ...
                        <label class="ms-2 " for="email">Next Step</label>
                        <div class="content d-none ms-3">
                            <div class="content__1  d-flex align-items-center">
                                <select class="user_system_select ">
                                    <option value="is">is</option>
                    ...
                    <li>
                        <input type="checkbox" class="check_btn" id="city">
                        <label class="ms-2 " for="city">Overall Sales Duration</label>
                    ...
                    <li>
                        <input type="checkbox" class="check_btn" id="city">
                        <label class="ms-2 " for="city">Probability (%)</label>
                    ...
                    <li>
                        ...
                        <label class="ms-2 " for="Fax">Reason For Loss</label>
                        <div class="content d-none ms-3">
                            <div class="content__1  d-flex align-items-center">
                                <select class="user_system_select ">
                                    <option value="is">is</option>
                    ...
                    <li>
                        <input type="checkbox" class="check_btn" id="city">
                        <label class="ms-2 " for="city">Sales Cycle Duration</label>
                    ...
                    <li>
                        <input type="checkbox" id="Fax" class="check_btn">
                        <label class="ms-2 " for="Fax">Stage</label>
                        <div class="content d-none ms-3">
                            <div class="content__1  d-flex align-items-center">
                                <select class="user_system_select ">
                                    <option value="is">is</option>
                                    ...
                                    <option value="is WON">is WON</option>
                                    <option value="is LOST">is LOST</option>
                                    <option value="is empty">is empty</option>
                                    <option value="is not empty">is not empty</option>
                                </select>
                            </div>
                    ...
                    <li>
                        <input type="checkbox" id="Fax" class="check_btn">
                        <label class="ms-2 " for="Fax">Tag</label>
                        <div class="content d-none ms-3">
                            <div class="content__1  d-flex align-items-center">
                                <select class="user_system_select ">
                                    <option value="is">is</option>
                    ...
                    <li>
                        <input type="checkbox" id="Fax" class="check_btn">
                        <label class="ms-2 " for="Fax">Type</label>
                        <div class="content d-none ms-3">
                            <div class="content__1  d-flex align-items-center">
                                <select class="user_system_select ">
                                    <option value="is">is</option>
