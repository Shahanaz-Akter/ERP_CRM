            ...
            <div class="p-3" style="">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="header p-3 d-flex slign-items-center justify-content-end ">
                        <div class="start">
                            <div class="btn-group">
                                <button type="button" class="btn btn-primary"><a href="/create_contacts"
                                        class="text-white">Create Contact</a></button>
                        ...
                        <div class="middle ms-3">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="{{url('/contacts/contacts-delete')}}">Mass Delete</a>
                                    </li>
                                    <li><a class="dropdown-item" href="{{url('/contacts/contacts-update')}}">Mass Update</a>
                                    </li>
                                    {{-- <li><a class="dropdown-item" href="{{url('/leads/mass-convert')}}">Mass Convert</a>
                                    </li> --}}
                                    <li><a class="dropdown-item" href="{{url('/contacts/contacts-manage-tags')}}">Manage Tags</a>
                                    </li>
                                    <li><a class="dropdown-item" href="{{url('/contacts/contacts-drafts')}}">Drafts</a></li>
                                    <li><a class="dropdown-item" href="{{url('/contacts/mass-email')}}">Mass Email</a></li>
                                    <li><a class="dropdown-item"
                                            href="{{url('/contacts/autoresponders')}}">Autoresponders</a></li>
                                    <li><a class="dropdown-item" href="{{url('/contacts/approval')}}">Approve
                                        Contacts</a></li>
                                    <li><a class="dropdown-item" href="javascript:void(0);">Deduplicate Contacts</a></li>
