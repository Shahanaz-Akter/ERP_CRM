...
<body class="bg-white" style="color:black;">
    ...
    <div>
        <div class="d-flex align-content-center flex-wrap mx-3 mt-3">
            ...
            <p><span class="badge bg-secondary  pt-2">Contacts </span></p>
        </div>



        <p class="ms-5">All the Tags associated with Contacts are listed below. You can rename or delete Tags from the available options.</p>
