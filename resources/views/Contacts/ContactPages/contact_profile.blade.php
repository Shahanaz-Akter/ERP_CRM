    ...
    <div class="">
        ...
        <div style="background-color:#fff; width:100%"
            ...
            <div class="pe-5">
                ...
                <button type="button" class="btn btn-secondary" onclick="window.location.href='{{ url('/contacts/editProfile') }}'">Edit</button>
            ...
            <div style="height:100vh; overflow:scroll; " class=" col-sm-8 col-md-9 col-lg-9 col-xl-10 px-0">
                ...
                <div style="" class="" id="scroll-container">
                    ...
                    <div class="info-container">
                        <h5 style="color:black">Contacts Information</h5>
                        <div class="row mx-4">
                            <div class="col-xl-6 col-lg-8 col-md-9 d-flex">
                                <div class="me-5 text-end">
                                    <span class="d-block">Contacts Owner</span>
                                    ...
                                    <span class="d-block">Phone</span>
                                    <span class="d-block line-space">Mobile</span>
                                    <span class="d-block">Contacts Source</span>
                            ...
                            <div class="col-xl-6 col-lg-8 col-md-9 d-flex">
                                <div class="me-5 text-end">
                                    ...
                                    <span class="d-block line-space">Contacts Name</span>
