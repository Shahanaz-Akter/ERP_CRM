<div style="width:380px;" class="filter_sidebar">
    <label class="p-2">Filter Leads By</label>
    <div class="search_btn d-flex align-items-center p-2 position-relative">
        ...
        <input type="text" id="myInput" style="border:1px solid gray;width: 90%; border-radius:15px;padding:4px 8px 4px 30px;" placeholder="Search Here">
    </div>
            ...
            <!-- <li>
                ...
                <ul class=" outer_ul">
                    <li>
                        ...
                        <input type="checkbox" id="touched_records" class="check_btn check_btn1">
                    ...
                    <li>
                        ...
                        <input type="checkbox" class="check_btn check_btn1" id="untouched_records">
                    ...
                    <li>
                        ...
                        <input type="checkbox" class="check_btn check_btn1" id="record_action">
                    ...
                    <li>
                        <input type="checkbox" id="latest_email_status" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="activities" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="notes" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="campaigns" class="check_btn check_btn1">
            ...
            <li>
                ...
                <ul class="outer_ul">
                            ...
                            <div class="content__1 ms-3 d-flex align-items-center">
                                <select name="" id="">
                                    ...
                                    <option value="less than">
                                        <p>
                                            < </p> </option> <option value="less than equal">
                                                <p>
                                                    <= </p> </option> <option value="greater than">>
                                    </option>
                    ...
                    <li>
                        ...
                        <input type="checkbox" class="check_btn check_btn1" id="city">
                    ...
                    <li>
                        ...
                        <input type="checkbox" class="check_btn check_btn1" id="company">
                    ...
                    <li>
                        <input type="checkbox" id="converted_account" class="mb-1 check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="converted_contact" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="converted_deal" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="country" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="created_by" class="check_btn check_btn1">
                        ...
                        <div class="content d-none ms-3">
                            ...
                            <div class="content__2  ">
                                ...
                                <input type="text" class="d-none" id="selectedUsers" readonly style="width:100%;" />
                    ...
                    <li>
                        <input type="checkbox" id="created_time" class="check_btn check_btn1">
                        ...
                        <div class="content d-none ms-3">
                            <div class="content__2 text-align-center d-flex">
                                ...
                                <input type="text" placeholder="2" style="width: 50px;margin:0;" class="text-center">
                    ...
                    <li>
                        <input type="checkbox" id="email" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="email_opt_out" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="enrich_status" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="Fax" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="first_name" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="industry" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="last_activity_time" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="last_enriched_time" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="last_name" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="lead_conversation_time" class="check_btn check_btn1">
                            ...
                            <div class="content__1 ms-3 d-flex align-items-center">
                                <select name="" id="">
                                    ...
                                    <option value="less than">
                                        ...
                                        < </option> <option value="less than equal">
                    ...
                    <li>
                        <input type="checkbox" id="lead_name" class="check_btn check_btn1">
                        ...
                        <div class="content d-none ms-3">
                            ...
                            <div class="content__2 mt-1 mb-2">
                                <input type="text" placeholder="Type Here" style="width:100%;border:1px solid gray;" class="">
                            </div>
                        </div>
                    </li>

                    <li>
                        <input type="checkbox" id="lead_owner" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="lead_source" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="lead_status" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="mobile" class="check_btn check_btn1">
                        ...
                        <div class="content d-none ms-3">
                            ...
                            <div class="content__2 mt-1 mb-2">
                                <input class="form-control" type="text" placeholder="Type Here" style="width:100%;border:1px solid gray;" class="">
                            </div>
                        </div>
                    </li>
                    <li>
                        <input type="checkbox" id="modified_by" class="check_btn check_btn1">
                        ...
                        <div class="content d-none mb-3 ms-3">
                            ...
                            <div class="content__2  ">
                                <div class=" mt-1 g-1">
                                    <div class="d-none" id="all_container__3">
                                        <label for="select2Success" class="form-label">All</label>
                                        <div class="select2-primary">
                                            <select id="all__3" class="select2 " multiple>
                                                <option value="1">Option1</option>
                                                <option value="2">Option2</option>
                                                <option value="3">Option3</option>
                                                <option value="4">Option4</option>
                                    ...
                                    <div class="d-none" id="active_container__3">
                                        <label for="active__3" class="form-label">Active</label>
                                        <div class="select2-primary">
                                            <select id="active__3" class="select2 form-select" multiple>
                                                <option value="1">Option1</option>
                                                <option value="2">Option2</option>
                                                <option value="3">Option3</option>
                                                <option value="4">Option4</option>
                                    ...
                                    <div class="d-none" id="inactive_container__3">
                                        <label for="inactive__3" class="form-label">Inactive</label>
                                        <div class="select2-primary">
                                            <select id="inactive__3" class="select2 form-select" multiple>
                                                <option value="1">Option1</option>
                                                <option value="2">Option2</option>
                                                <option value="3">Option3</option>
                                                <option value="4">Option4</option>
                                    ...
                                    <div class="d-none" id="unconfirmed_container__3">
                                        <label for="unconfirmed__3" class="form-label">Unconfirmed</label>
                                        <div class="select2-primary">
                                            <select id="unconfirmed__3" class="select2 form-select" multiple>
                                                <option value="1">Option1</option>
                                                <option value="2">Option2</option>
                                                <option value="3">Option3</option>
                                                <option value="4">Option4</option>
                                    ...
                                    <div class="d-none" id="deleted_container__3">
                                        <label for="deleted__3" class="form-label">Deleted</label>
                                        <div class="select2-primary">
                                            <select id="deleted__3" class="select2 form-select" multiple>
                                                <option value="1">Option1</option>
                                                <option value="2">Option2</option>
                                                <option value="3">Option3</option>
                                                <option value="4">Option4</option>
                                ...
                                <script>
                                    const userType__3 = document.getElementById("userType__3");
                                    const all__3 = document.getElementById("all__3");
                                    const all_container__3 = document.getElementById("all_container__3");

                                    const active__3 = document.getElementById("active__3");
                                    const active_container__3 = document.getElementById("active_container__3");

                                    const inactive__3 = document.getElementById("inactive__3");
                                    const inactive_container__3 = document.getElementById("inactive_container__3");

                                    const unconfirmed__3 = document.getElementById("unconfirmed__3");
                                    const unconfirmed_container__3 = document.getElementById("unconfirmed_container__3");

                                    const deleted__3 = document.getElementById("deleted__3");
                                    const deleted_container__3 = document.getElementById("deleted_container__3");


                                    userType__3.addEventListener("change", function() {
                                        if (this.value == "all") {
                                            all_container__3.classList.remove('d-none');
                                        }
                                        if (this.value == "active") {
                                            active_container__3.classList.remove('d-none');
                                        }
                                        if (this.value == "inactive") {
                                            inactive_container__3.classList.remove('d-none');
                                        }
                                        if (this.value == "unconfirmed") {
                                            unconfirmed_container__3.classList.remove('d-none');
                                        }
                                        if (this.value == "deleted") {
                                            deleted_container__3.classList.remove('d-none');
                                        }
                                    });
                                </script>
                            </div>
                    ...
                    <li>
                        <input type="checkbox" id="modified_time" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="no_of_emnployees" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="phone" class="check_btn check_btn1">
                        <label class="ms-2 " for="phone">Phone</label>
                        <div class="content d-none ms-3">
                            <div class="content__1  d-flex align-items-center">
                                <select class="user_system_select ">
                                    <option value="is">is</option>
                    ...
                    <li>
                        <input type="checkbox" id="rating" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="salutation" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="secondary_email" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="skype_id" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="state" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="street" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="tag" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="title" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="twitter" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="unsubscribed_mode" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="unsubscribed_time" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="website" class="check_btn check_btn1">
                    ...
                    <li>
                        <input type="checkbox" id="zip_code" class="check_btn check_btn1">
                        <label class="ms-2 " for="zip_code">Zip Code</label>
                        <div class="content d-none ms-3">
                            <div class="content__1  d-flex align-items-center">
                                <select class="user_system_select ">
                                    <option value="is">is</option>
    ...
    <div class="mt-3 mb-2 fixed-bottom d-none apply_filter">
        <span><button class="btn btn-primary ms-2 me-2" type="submit">Apply Filter</button></span>
        <span><button class="btn btn-danger" type="submit">Cancel</button></span>
    </div>
</div>
...
<!-- Selecting using foreach loop and Clicking all the nodelist array Item -->
<script>
    let check_btn1 = document.querySelectorAll('.check_btn1');
    // console.log(check_btn1);

    let apply_filter = document.querySelector('.apply_filter');
    check_btn1.forEach((event) =>

        event.addEventListener('click', function() {

            let contain = apply_filter.classList.contains('d-none');
            if (contain) {
                apply_filter.classList.remove('d-none');

            } else {
                apply_filter.classList.add('d-none');
