            ...
            <div class="p-3" style="">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="header p-3 d-flex slign-items-center justify-content-end ">
                        <div class="start">
                            <div class="btn-group">
                                <button type="button" class="btn btn-primary"><a href="/create_leads" class="text-white">Create
                                        Lead</a></button>
                                <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false">
                                    <span class="visually-hidden">Toggle Dropdown</span>
                                </button>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="javascript:void(0);">Import Leads</a></li>
                        ...
                        <div class="middle ms-3">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="{{url('/leads/mass-delete')}}">Mass Delete</a>
                                    </li>
                                    <li><a class="dropdown-item" href="{{url('/leads/mass-update')}}">Mass Update</a>
                                    </li>
                                    <li><a class="dropdown-item" href="{{url('/leads/mass-convert')}}">Mass Convert</a>
                                    </li>
                                    <li><a class="dropdown-item" href="{{url('/leads/manage-tags')}}">Manage Tags</a>
                                    </li>
                                    <li><a class="dropdown-item" href="{{url('/leads/drafts')}}">Drafts</a></li>
                                    <li><a class="dropdown-item" href="{{url('/leads/mass-email')}}">Mass Email</a></li>
                                    <li><a class="dropdown-item" href="{{url('/leads/autoresponders')}}">Autoresponders</a></li>
                                    <li><a class="dropdown-item" href="{{url('/leads/lead-approval')}}">Approve
                                            Leads</a></li>
                                    <li><a class="dropdown-item" href="javascript:void(0);">Duplicate Leads</a></li>
                                    <li><a class="dropdown-item" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#modalTop">Add to Campaigns</a></li>
                ...
                @include('Leads.LeadsPages.leads_list_1')
